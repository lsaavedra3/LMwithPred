...
## Conclusion    
We reject the Null Hypothesis because There IS a difference in these regression   models, Model 1 Rsquare value is   0.467, Model 2 Rsquare value 0.4053,and for model 3 where the first two were combined gave us an Rsquare value of 1.495e-09. since model 1 is the smallest one that means that model 1 works better than the other two, the Rsquare can never be bigger than 1.  
