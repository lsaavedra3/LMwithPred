...
```
In this last Analysis we have added Model 1 and Model 3,using anova. The value that it gives us is of 1.495e-09. By adding these results we conclude that the first model is a better model of the three because is Rsuare is more than 1.  
## Conclusion    
We reject the Null Hypothesis because There IS a difference in these regresion   models, Model 1 works better than the other two.    
